...
exp_name="${base_name}_meanflow_embed_${img_height}_${img_width}_condemb_${cond_embedder}_mchannel_${model_channels}_puncond_${p_uncond}_rneqt_${mf_ratio_r_neq_t}_${mf_time_sampler}"
...
srun uv run torchrun \
    ...
    ./src/training/train_meanflow.py ${ARGS[@]} | tee "./checkpoints/$exp_name/log.out"
EOF
